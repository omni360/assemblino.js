function Gripper(){
    ...
    system.setDistance = function(v){
        ...
        controls[0].setPosition(v);
        controls[1].setPosition(v);
    };
    system.open = function(v){
         this.setDistance(v || 0);
    };
    system.close = function(v){
        this.setDistance(v || (options.size/2-thickness/2));
    };
    setTimeout(function(){
        var c = system.addGUIController({distance: 0},'distance', 0, options.size/2-thickness/2);
